...
<EnhancedCTAButton 
  title="Transform Your Mental Programming"
  description="Discover how to create lasting mindset changes by working with your subconscious mind instead of against it."
...
<EnhancedCTAButton 
  title="Develop Natural Confidence"
  description="Build the kind of mindset that creates automatic confidence and resilience without constant effort or maintenance."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  title="Master the Three-Phase Process"
  description="Learn the systematic approach that creates lasting mindset transformation through subconscious reprogramming and conscious integration."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  ...
  description="Apply mindset transformation principles to create positive changes in your career, relationships, finances, and health."
  url="/store/conquering-confidence"
  variant="blue"
/>
...
<EnhancedCTAButton 
  ...
  description="Design a customized mindset transformation strategy that works with your specific patterns and goals."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  title="Access the Complete System"
  description="Get the systematic 6-week approach that creates lasting mindset transformation through proven psychological principles."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
