...
<EnhancedCTAButton 
  ...
  description="Stop letting childhood interpretations run your adult life. Learn to identify and rewrite the stories that limit your potential."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  ...
  description="Use proven neuroscience to rewire your brain so confidence becomes your natural response, not something you have to fake."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  ...
  description="Stop pretending to be someone you're not. Access your authentic confidence so you can show up as yourself in any situation."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  ...
  description="Identify your specific limiting stories so you can target the real problem instead of wasting time on surface symptoms."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  ...
  description="Get the complete system that rewrites limiting stories at the subconscious level so confidence becomes your natural state."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  ...
  description="Develop the inner confidence to express your ideas, set boundaries, and command respect in any professional situation."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  ...
  description="Develop unshakeable self-trust so you can make decisions with confidence and stop second-guessing yourself constantly."
  url="/store/conquering-confidence"
  variant="blue"
/>
