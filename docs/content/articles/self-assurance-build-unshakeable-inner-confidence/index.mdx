...
<EnhancedCTAButton 
  title="Develop Unshakeable Self Trust"
  description="Learn what real self assurance looks like internally and externally, plus how it differs from fake confidence that crumbles under pressure."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  title="Stop Wasting Time on Fake Fixes"
  description="Discover why affirmations, power poses, and visualization don't work and what actually creates lasting confidence from within."
  url="/store/conquering-confidence"
  variant="blue"
/>
...
<EnhancedCTAButton 
  title="Build These 6 Confidence Pillars"
  description="Master self trust, values clarity, emotional mastery, growth mindset, authentic expression, and future self connection systematically."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  title="Avoid the Arrogance Trap"
  description="Learn the crucial difference between self assurance and arrogance, and how to build confidence that attracts rather than repels people."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
...
<EnhancedCTAButton 
  title="Stop These Confidence Killers"
  description="Identify and overcome perfectionism, comparison trap, people pleasing, and past failure focus that destroy natural confidence."
  url="/store/conquering-confidence"
  variant="blue"
/>
...
<EnhancedCTAButton 
  title="Design Your Confidence Environment"
  description="Learn how to structure your physical space, relationships, and daily routines to reinforce and maintain your self assurance."
  url="/store/conquering-confidence"
  variant="yellow"
/>
...
<EnhancedCTAButton 
  title="Start Building Real Confidence"
  description="Begin the systematic 6-week process to identify and rewrite your limiting stories before they control another day of your life."
  url="/store/conquering-confidence"
  variant="light-blue"
/>
